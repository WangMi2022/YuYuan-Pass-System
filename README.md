...
<p align="center">
  <a href="docs/images/admin-ui-lifecycle-orbit.png">
    <img src="docs/images/admin-ui-lifecycle-orbit.png" alt="生命周期轨道 04 风格后台工作台" width="100%" />
  </a>
</p>

<p align="center">
  生命周期轨道 04 视觉体系：顶部动态导航、紫色主题、轻量工作区与原业务 Dashboard。
</p>
...
- 首页保留原有问候横幅、资产指标、快捷入口和最新公告，指标区域调整为 04 风格的分段数据条。
...
- 首页工作台保留问候横幅、资产概览、权限感知快捷入口与最新公告；横幅与资产大屏内置 Three.js 粒子特效，颜色跟随主题色与暗色模式，并支持 reduced-motion 降级。
