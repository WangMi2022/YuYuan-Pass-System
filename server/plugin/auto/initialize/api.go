...
func Api(ctx context.Context) {
	...
	entities := []model.SysApi{
		...
		{Path: "/autoCode/llmAuto", Description: "调用 AI 自动代码服务", ApiGroup: "代码生成器", Method: "POST"},
		{Path: "/autoCode/llmAutoSSE", Description: "调用 AI 流式自动代码服务", ApiGroup: "代码生成器", Method: "POST"},
		{Path: "/autoCode/initMenu", Description: "初始化插件菜单文件", ApiGroup: "代码生成器", Method: "POST"},
		{Path: "/autoCode/initAPI", Description: "初始化插件 API 文件", ApiGroup: "代码生成器", Method: "POST"},
		{Path: "/autoCode/initDictionary", Description: "初始化插件字典文件", ApiGroup: "代码生成器", Method: "POST"},
