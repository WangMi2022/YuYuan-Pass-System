...
func Menu(_ context.Context) {
	menus := []system.SysBaseMenu{
		...
		{
			Path: "assetRecognition", Name: "assetRecognition", Hidden: false,
			Component: "plugin/asset/view/recognition.vue", Sort: 2,
			Meta: system.Meta{Title: "智能建档", Icon: "camera", KeepAlive: true},
		},
		{
			Path: "assetInventory", Name: "assetInventory", Hidden: false,
			Component: "plugin/asset/view/assets.vue", Sort: 3,
			Meta: system.Meta{Title: "资产档案", Icon: "list", KeepAlive: true},
		},
		{
			Path: "assetCategories", Name: "assetCategories", Hidden: false,
			Component: "plugin/asset/view/categories.vue", Sort: 4,
			Meta: system.Meta{Title: "分类管理", Icon: "collection-tag", KeepAlive: true},
		},
		{Path: "assetInbound", Name: "assetInbound", Component: "plugin/asset/view/operations.vue", Sort: 5, Meta: system.Meta{Title: "入库管理", Icon: "box"}},
		{Path: "assetIssue", Name: "assetIssue", Component: "plugin/asset/view/operations.vue", Sort: 6, Meta: system.Meta{Title: "领用管理", Icon: "user"}},
		{Path: "assetTransfer", Name: "assetTransfer", Component: "plugin/asset/view/operations.vue", Sort: 7, Meta: system.Meta{Title: "调拨管理", Icon: "switch"}},
		{Path: "assetReturn", Name: "assetReturn", Component: "plugin/asset/view/operations.vue", Sort: 8, Meta: system.Meta{Title: "归还管理", Icon: "refresh-left"}},
		{Path: "assetMaintenance", Name: "assetMaintenance", Component: "plugin/asset/view/operations.vue", Sort: 9, Meta: system.Meta{Title: "维修管理", Icon: "tools"}},
		{Path: "assetScrap", Name: "assetScrap", Component: "plugin/asset/view/operations.vue", Sort: 10, Meta: system.Meta{Title: "报废管理", Icon: "delete"}},
	}
