...
import (
	...
	"github.com/WangMi2022/mit-assets-admin/server/docs"
...
func Routers() *gin.Engine {
	...
	if strings.EqualFold(strings.TrimSpace(os.Getenv("GVA_ENABLE_PUBLIC_UPLOADS")), "true") {
	...
	if gin.Mode() == gin.DebugMode || strings.EqualFold(strings.TrimSpace(os.Getenv("GVA_ENABLE_SWAGGER")), "true") {
		PrivateGroup.GET("/swagger/*any", ginSwagger.WrapHandler(swaggerFiles.Handler))
		global.GVA_LOG.Info("register protected swagger handler")
	}
