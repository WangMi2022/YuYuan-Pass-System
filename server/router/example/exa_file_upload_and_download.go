...
func (e *FileUploadAndDownloadRouter) InitFileUploadAndDownloadRouter(Router, PublicRouter *gin.RouterGroup) {
	...
	PublicRouter.GET("fileUploadAndDownload/preview", exaFileUploadAndDownloadApi.PreviewFile)
}
