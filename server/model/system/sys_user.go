...
type SysUser struct {
	...
	HeaderImgPreviewURL string         `json:"headerImgPreviewUrl" gorm:"-"`                                                         // 私有头像临时预览地址
	...
	SecurityVersion     uint64         `json:"-" gorm:"not null;default:0;comment:会话安全版本"`
...
func (s *SysUser) GetSecurityVersion() uint64 {
	return s.SecurityVersion
}
