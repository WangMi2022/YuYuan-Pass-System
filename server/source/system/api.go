...
func (i *initApi) InitializeData(ctx context.Context) (context.Context, error) {
	...
	entities := []sysModel.SysApi{
		...
		{ApiGroup: "系统用户", Method: "GET", Path: "/user/contactVerificationCapabilities", Description: "获取联系方式验证码能力"},
		{ApiGroup: "系统用户", Method: "POST", Path: "/user/sendContactVerificationCode", Description: "发送联系方式验证码"},
		{ApiGroup: "系统用户", Method: "PUT", Path: "/user/updateSelfContact", Description: "验证并更新自身联系方式"},
		...
		{ApiGroup: "代码生成器", Method: "POST", Path: "/autoCode/llmAuto", Description: "调用 AI 自动代码服务"},
		{ApiGroup: "代码生成器", Method: "POST", Path: "/autoCode/llmAutoSSE", Description: "调用 AI 流式自动代码服务"},
		{ApiGroup: "代码生成器", Method: "POST", Path: "/autoCode/initMenu", Description: "初始化插件菜单文件"},
		{ApiGroup: "代码生成器", Method: "POST", Path: "/autoCode/initAPI", Description: "初始化插件 API 文件"},
		{ApiGroup: "代码生成器", Method: "POST", Path: "/autoCode/initDictionary", Description: "初始化插件字典文件"},
