<template>
  <main class="na-page na-page--list monitor-page" aria-labelledby="server-monitor-title">
    <header class="na-page-header monitor-header">
      <div>
    ...
    <section class="kpi-grid" aria-label="服务器核心负载指标">
      <article class="na-panel metric-card">
    ...
    <section class="primary-grid">
      <article class="na-panel monitor-card trend-card">
        <header class="na-panel-header card-header">
...
.monitor-page { overflow-x: hidden; }
...
.metric-card { display: grid; grid-template-columns: 46px minmax(0, 1fr); gap: 12px; padding: 17px; }
...
@media (max-width: 800px) { .monitor-header { align-items: stretch; flex-direction: column; }.monitor-actions { justify-content: flex-start; }.detail-grid { grid-template-columns: 1fr; }.core-grid { grid-template-columns: 1fr; } }
