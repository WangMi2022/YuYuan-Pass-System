    ...
    >
      ...
      >
        <div class="text-lg">
          ...
          <p class="text-gray-600 dark:text-gray-300 mb-2">
            2.请您确认是否已经阅读项目 README、部署说明和数据库初始化说明
          </p>
          <p class="text-gray-600 dark:text-gray-300 mb-2">
            3.请您确认是否了解后续的配置流程
          </p>
          ...
          <p class="text-gray-600 dark:text-gray-300 mb-2">
            注：初始化前请确认数据库、Redis、OSS 等基础配置可用
          </p>
...
<script setup>
  ...
  const goDoc = () => {
    ElMessage.info('请查看项目 README、REMOTE.md 或 deploy 目录下的部署说明')
  }
...
<style lang="scss" scoped>
  .na-init-page {
    ...
    overflow: auto;
    background:
      radial-gradient(circle at 20% 10%, rgb(63 158 232 / 12%), transparent 28%),
  ...
  .na-init-card :deep(.el-form) { width: 100%; }
  @media (max-width: 700px) {
    .na-init-page { padding: 14px; }
    .na-init-card { min-height: auto; padding: 26px 18px; }
  }
  .slide-in-fwd-top {
