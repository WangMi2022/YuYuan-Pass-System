  ...
  <div>
    ...
    <div class="gva-search-box" v-if="!isAdd">
      <div class="text-lg mb-2 text-gray-600">
        使用 AI 创建
        <span class="text-gray-500 text-sm ml-4">请先在 config.yaml 的 autocode.ai-path 配置自有 AI 服务地址</span>
      </div>
      <div class="relative">
        <el-input
          v-model="prompt"
        ...
        <div class="flex absolute right-28 bottom-2">
          <el-tooltip effect="light">
            <template #content>
              <div>
                请将自有 AI 服务地址填入 config.yaml 的 autocode.ai-path 后使用。
              </div>
            </template>
            <el-button
