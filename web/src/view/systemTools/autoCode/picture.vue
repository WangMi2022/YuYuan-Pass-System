<template>
  <div>
    <warning-bar
        title="本功能依赖 config.yaml 中 autocode.ai-path 配置的自有 AI 服务，请在开发环境使用。"
    />
<div class="gva-search-box">
      <div class="text-xl mb-2 text-gray-600 dark:text-slate-300">
        AI 前端工程师
        <span class="text-gray-500 text-sm ml-4 dark:text-slate-400">请配置自有 AI 服务地址</span>
      </div>
      ...
      <div class="relative">
        ...
        <div class="flex absolute right-2 bottom-2">
          <el-tooltip effect="light">
            <template #content>
              <div>
                请先在 config.yaml 的 autocode.ai-path 中配置自有 AI 服务地址。
              </div>
            </template>
            <el-button
                type="primary"
