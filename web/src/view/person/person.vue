<template>
  <div class="na-page profile-container">
    <!-- 顶部个人信息卡片 -->
    <div class="na-panel profile-hero">
      <!-- 顶部背景图 -->
      <div class="profile-banner h-48 relative" />
...
<style scoped lang="scss">
  .profile-container {
    ...
    .profile-banner { background: var(--na-primary-soft); }
    .profile-card { margin-bottom: 18px; padding: 24px; }
