      ...
      <div class="gva-theme-section-content">
        <div class="gva-theme-card-bg">
          <div class="flex items-start gap-5">
            ...
            <div class="flex-1">
              <h4 class="text-xl font-semibold gva-theme-text-main mb-3">资产管理中心</h4>
              <p class="text-sm gva-theme-text-sub mb-5 leading-relaxed">
                基于 Vue3 + Gin 的资产管理后台，支持资产档案、数据大屏、Excel 导入导出和 OSS 存储
              </p>
              <div class="flex items-center gap-3 text-sm gva-theme-text-sub">
                <span>当前系统已按资产管理场景完成二次开发。</span>
              </div>
            </div>
          </div>
        </div>
