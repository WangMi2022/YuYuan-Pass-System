...
| [前端主题与视觉规范](../FRONTEND-STYLE.md) | 产品、设计、前端 | 视觉原则、主题令牌、组件覆盖、亮暗模式与响应式约定 |
...
| [M3/M4 生产响应式验收记录](M3-M4-RESPONSIVE-VALIDATION.md) | 产品、研发、测试、交付 | 发票质量和智能建档三档页面的 DOM/几何证据、截图限制与剩余抽屉验收项 |
...
| [租户与部门级数据隔离实施规格](TENANT-DEPARTMENT-DATA-ISOLATION.md) | 架构师、后端、测试、运维 | 租户根边界、部门树、角色数据范围、迁移顺序和验收矩阵 |
